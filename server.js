...
chartData.forEach((d,idx)=>{
  ...
  new Chart(canvas,{
    ...
    data:{labels:d.labels,datasets:[
      {label:'With Traffic',data:d.traffic,borderColor:'#dc2626',backgroundColor:'rgba(220,38,38,0.04)',borderWidth:1.5,pointRadius:1.5,pointHoverRadius:4,fill:true,tension:0.3},
      {label:'Normal',data:d.normal,borderColor:'#2563eb',backgroundColor:'transparent',borderWidth:1,borderDash:[4,4],pointRadius:1,pointHoverRadius:3,fill:false,tension:0.3}
    ]},
