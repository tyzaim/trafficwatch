...
function buildMainPage() {
  ...
  <div class="card">
    ...
    <div style="overflow-x:auto"><table>
      <thead><tr><th>Time</th><th>Crossing</th><th>Direction</th><th>Traffic</th><th>Normal</th><th>Delay</th><th>Speed</th><th>Status</th></tr></thead>
      <tbody>${(()=>{
        const all=[];
...
function buildDetailPage(id) {
  ...
  <div class="grid-2">
    ${c.routes.map((route,ri)=>{
      ...
      return `<div class="card">
        ...
        ${l?`
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;padding:18px 22px;border-bottom:1px solid var(--border)">
          <div>
          ...
          <div style="border-left:1px solid var(--border);padding-left:16px">
            ...
            <div class="metric-big" style="color:var(--blue);font-size:32px">${l.normalMin}</div>
            <div class="metric-unit">minutes</div>
          </div>
          <div style="border-left:1px solid var(--border);padding-left:16px">
  ...
  <div class="card">
    ...
    <div style="overflow-x:auto"><table>
      <thead><tr><th>Time</th><th>Direction</th><th>Traffic</th><th>Normal</th><th>Delay</th><th>Speed</th><th>Weather</th><th>Status</th></tr></thead>
      <tbody>${(()=>{
        const all=[];
